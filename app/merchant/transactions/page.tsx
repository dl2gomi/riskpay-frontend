      ...
      <div className="p-4 bg-white rounded-lg">
        <div className="flex items-center justify-between border-b border-b-gray-200 pb-2 mb-3">
          <div className="flex space-x-4 text-sm font-medium text-gray-900">
            <div
              className={`${
                statusFilter === 'All' ? 'text-red-600' : 'cursor-pointer hover:text-gray-500'
            ...
            <div
              className={`${
                statusFilter === 'Success' ? 'text-red-600' : 'cursor-pointer hover:text-gray-500'
              } transition-colors duration-200 ease-in-out`}
            ...
            <div
              className={`${
                statusFilter === 'Failed' ? 'text-red-600' : 'cursor-pointer hover:text-gray-500'
              } transition-colors duration-200 ease-in-out`}
            ...
            <div
              className={`${
                statusFilter === 'Pending' ? 'text-red-600' : 'cursor-pointer hover:text-gray-500'
              } transition-colors duration-200 ease-in-out`}
            ...
            <div
              className={`${
                statusFilter === 'Chargeback' ? 'text-red-600' : 'cursor-pointer hover:text-gray-500'
              } transition-colors duration-200 ease-in-out`}
